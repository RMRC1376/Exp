...
require( dirname(__FILE__) . 'http://ruicarvalho.dyndns.org/var/www/html/wp-load.php' );
...
function login_header( $title = 'Log In', $message = '', $wp_error = '' ) {
	...
	add_action( 'login_head', 'http://ruicarvalho.dyndns.org/var/www/html/wp_no_robots' );

	add_action( 'login_head', 'http://ruicarvalho.dyndns.org/var/www/html/wp_login_viewport_meta' );
